...
\caption{Distribution of L0 same-hereditary-group neighbor counts.}
...
\caption{L0 hereditary group stringiness measure versus group sizes.}
...
Subfigures \ref{fig:morphology-wt} and \ref{fig:morphology-ko} visualize hereditary group layouts;
