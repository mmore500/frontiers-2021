...
{\dissertationelse{(a)}{\textbf{(A)}} Regulation visualizations}
...
{\dissertationelse{(b)}{\textbf{(B)}} Interior propagule rate by genotype}
...
Subfigure \dissertationelse{\ref{fig:ko-interior_propagule}a}{\textbf{(A)}} compares gene regulation between analyzed strains.
...
Subfigure \dissertationelse{\ref{fig:ko-interior_propagule}b}{\textbf{(B)}} compares the mean number of interior propagules observed per L1 hereditary group.
