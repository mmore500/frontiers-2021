...
Useful as a concrete illustration of this scheme, Figure \ref{fig:ko-morphology}\dissertationelse{a}{\textbf{(A)}} depicts hierarchically-nested hereditary groupings assumed by an evolved strain.
...
As sketched in Figure \ref{fig:signalgp-dishtinygp}\dissertationelse{a}{\textbf{(A)}}, this representation is specially designed to express function-like modules of code in response to internal signals or external stimuli.
...
Figure \ref{fig:signalgp-dishtinygp}\dissertationelse{b}{\textbf{(B)}} overviews the configuration of the four SignalGP instances that constitute a single cell.
